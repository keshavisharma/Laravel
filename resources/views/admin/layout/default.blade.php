...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="{{route('admin-dashboard')}}" class="navbar-brand nav-link"><img alt="branding logo" src="{{asset('admin-assets')}}/app-assets/images/logo/robust-logo-light.png" data-expand="{{asset('admin-assets')}}/app-assets/images/logo/robust-logo-light.png" data-collapse="{{asset('admin-assets')}}/app-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('admin-assets')}}/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">{{$user->name}}</span></a>
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{asset('admin-assets')}}/app-assets/js/scripts/pages/dashboard-2.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
    @yield('footer-js')
  </body>
</html>
