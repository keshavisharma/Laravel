    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                ...
                <form class="form-horizontal form-simple" action="{{route('admin-loginCheck')}}" novalidate method="POST">
                    @csrf
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Your Email ID" name="email" required>
